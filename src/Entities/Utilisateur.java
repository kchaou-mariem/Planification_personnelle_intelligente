...
public class Utilisateur {
	...
	// generateSalt() crée une valeur aléatoire (le "sel") utilisée pour renforcer
	...
	private String hash_password(String motdepasse, String salt) {
		try {
			MessageDigest digest = MessageDigest.getInstance("SHA-256");// MessageDigest est une classe intégrée de Java
																		// (dans java.security) qui permet de calculer
