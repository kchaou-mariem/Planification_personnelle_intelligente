...
public interface ConflitDAO {
     ...
     * @param idUtilisateur L'ID de l'utilisateur
     * @return Nombre de conflits pour cet utilisateur
     */
    ...
    /**
     * Obtenir les statistiques par type de conflit
     * @return Map associant chaque type au nombre de conflits
     */
    Map<TypeConflit, Integer> getStatistiquesParType();
    
    // ========== OPÉRATIONS DE MAINTENANCE ==========
    
    /**
     * Supprimer les conflits résolus avant une date donnée
     * @param dateAvant Date limite (conflits avant cette date seront supprimés)
     * @return Nombre de conflits supprimés
     */
    int supprimerConflitsResolusAvant(LocalDateTime dateAvant);
    
    /**
     * Archiver les conflits avant une date donnée
    ...
    /**
     * Rechercher des conflits par mot-clé
    ...
    /**
     * Récupérer les conflits les plus récents
     * @param limite Nombre maximum de conflits à retourner
     * @return Liste des conflits récents
     */
    List<Conflit> getConflitsRecents(int limite);
    
    /**
     * Récupérer les conflits critiques non résolus
