...
public interface ActiviteService {
    ...
    /**
     * Créer une mutation d'un planning en décalant aléatoirement une activité de ±30 minutes.
     * Utile pour les algorithmes d'optimisation (algorithmes génétiques, recherche locale).
